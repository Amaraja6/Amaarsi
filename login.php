...
if(isset($_POST['submit']))
  ...
  $sql = "select * from signup_details where s_username = '$user' and s_pass='$pass';";
    ...
    <head> 
        ...
        <body>
            ...
            <ul>
                ...
                <li><a href="login2.php"target="_blank">Login</a></li>
                <li><a href="contact.html"target="_blank">Contact Us</a></li>
                <li><a href="logout2.php"target="_blank">Logout</a></li>   
                ...
                <div class="container1" >
                    <div class="header">
                        <img src="amaarsifoot.png" class="logo2">
                        <h2>LOGIN</h2>
                    </div>
                    ...
                    <a style="margin-left:4%;" href="signup.html" target="_blank">Don't have an account? Click here</a>
            ...
            <footer>
                <img src="amaarsifoot.png" class="logo1">
